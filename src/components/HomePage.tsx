import { Camera, Image, Download, Sparkles, Upload } from 'lucide-react';
...
export function HomePage({ onStartBooth, onStartCustom }: HomePageProps) {
  const samples = [
    {
      id: 1,
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto">
            Create amazing photo strips with your friends! Capture memories, choose your favorites, and download instantly.
          </p>
        </div>
            ...
            <Card className="p-6 bg-white/10 backdrop-blur-md border-white/20 h-full transition-shadow duration-300 hover:shadow-2xl hover:shadow-[#D83F87]/30 hover:bg-white/15">
              <div className="flex flex-col items-center text-center gap-4">
                ...
                <p className="text-white/80 text-sm">
                  Automatic countdown timer takes 4 perfect shots with 10 seconds between each capture
                </p>
              </div>
            </Card>
          </motion.div>
          ...
          >
            <Card className="p-6 bg-white/10 backdrop-blur-md border-white/20 h-full transition-shadow duration-300 hover:shadow-2xl hover:shadow-[#D83F87]/30 hover:bg-white/15">
              <div className="flex flex-col items-center text-center gap-4">
                ...
                <p className="text-white/80 text-sm">
                  Select your 4 favorite shots and arrange them in a classic photo strip layout with white borders
                </p>
              </div>
            </Card>
          </motion.div>
          ...
          >
            <Card className="p-6 bg-white/10 backdrop-blur-md border-white/20 h-full transition-shadow duration-300 hover:shadow-2xl hover:shadow-[#D83F87]/30 hover:bg-white/15">
              <div className="flex flex-col items-center text-center gap-4">
                ...
                <p className="text-white/80 text-sm">
                  Download your photo strip instantly and share with friends
                </p>
              </div>
            </Card>
          </motion.div>
        ...
        <div className="mb-12">
          <div className="flex items-center justify-center gap-2 mb-8">
            ...
            <h2 className="text-3xl text-white text-center">Sample Photo Strips</h2>
            <Sparkles className="w-6 h-6 text-white" />
          </div>
          <div className="grid md:grid-cols-4 gap-6">
            {samples.map((sample) => (
              <Card key={sample.id} className="overflow-hidden bg-white/10 backdrop-blur-md border-white/20">
                <ImageWithFallback
                  src={sample.url}
                  alt={sample.alt}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <Button
            ...
            className="bg-white hover:bg-white/90 px-12 py-6 text-xl gap-3 w-full sm:w-auto"
            style={{ color: '#44318D' }}
          >
